...
class PerDoubleDQNModel(object):
    """
...
class PerDoubleDQNAgent(object):
    """
    Implementation of the Prioritized Double Deep Q-Learning RL technique
    """

    def __init__(self, *, env):
        self.env = env
        self.model = PerDoubleDQNModel(observation_space=env.observation_space.shape, action_space=env.action_space.n)
    ...
    def off_policy_train(self):
        ...
        """
        print("\nTRAINING (with PerDoubleDQN learning method)")
